  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-20 pointer-events-none">
        <div ref={titleRef} className="will-change-transform text-center opacity-0">
          <h1 className="text-5xl lg:text-7xl xl:text-[6.5rem] font-body font-extralight tracking-[0.2em] text-white uppercase leading-none">
            Villa
          </h1>
          <h1 className="text-5xl lg:text-7xl xl:text-[6.5rem] font-body font-extralight tracking-[0.2em] text-white uppercase leading-none mt-1">
            Médicis
          </h1>
        </div>
